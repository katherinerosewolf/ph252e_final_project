...
```{r simulated data ltmle package}
...
# simulated ltmle results

# reorder data
frm_time_order_sim <- frm.sim %>% 
  select("sex", 
         "educ", 
         "age_1", 
         "cigpday_1", 
...
# recode stroke to mimic survival (make it 1 permanently)
frm_for_ltmle_sim <- frm_time_order_sim %>% 
  mutate(stroke_2 = ifelse(stroke_1 == 1, 
                           1, 
                           stroke_2), 
         stroke_3 = ifelse(stroke_2 == 1, 
...
# get iptw and tmle
results_iptw_tmle_sim <- ltmleMSM(data = frm_for_ltmle_sim, 
                              Anodes = c("totchol_1", 
                                         "totchol_2", 
                                         "totchol_3"), 
                              Lnodes = c("sex", 
...
# get the gcomputation version
results_gcomp_sim <- ltmleMSM(data = frm_for_ltmle_sim, 
                          Anodes = c("totchol_1", 
                                     "totchol_2", 
                                     "totchol_3"), 
                          Lnodes = c("sex", 
...
# display results
summary(results_iptw_tmle_sim, "tmle")
summary(results_iptw_tmle_sim, "iptw")
summary(results_gcomp_sim, "gcomp")
